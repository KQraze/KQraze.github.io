 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nd=function(t){let e={},n={},s={},i="";try{const r=t.split(".");e=Fs(Uo(r[0])||""),n=Fs(Uo(r[1])||""),i=r[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:i}},lv=function(t){const e=Nd(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},cv=function(t){const e=Nd(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vb(t){Yt(new Rt("platform-logger",e=>new xv(e),"PRIVATE")),Yt(new Rt("heartbeat",e=>new gb(e),"PRIVATE")),_t(Wo,Uc,t),_t(Wo,Uc,"esm2017"),_t("fire-js","")}vb("");var qc={};const Vc="@firebase/database",Kc="1.0.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class RE extends Cr{compare(e,n){const s=e.node.compareTo(n.node);return s===0?xn(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return q.MIN}maxPost(){return q.MAX}makePost(e,n){const s=Se(e);return new q(n,s)}toString(){return".value"}}const OE=new RE;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JS="firebase-installations-database",QS=1,Rn="firebase-installations-store";let _o=null;function Al(){return _o||(_o=Er(JS,QS,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Rn)}}})),_o}async function er(t,e){const n=Mr(t),i=(await Al()).transaction(Rn,"readwrite"),r=i.objectStore(Rn),o=await r.get(n);return await r.put(e,n),await i.done,(!o||o.fid!==e.fid)&&gp(t,e.fid),e}async function yp(t){const e=Mr(t),s=(await Al()).transaction(Rn,"readwrite");await s.objectStore(Rn).delete(e),await s.done}async function Lr(t,e){const n=Mr(t),i=(await Al()).transaction(Rn,"readwrite"),r=i.objectStore(Rn),o=await r.get(n),a=e(o);return a===void 0?await r.delete(n):await r.put(a,n),await i.done,a&&(!o||o.fid!==a.fid)&&gp(t,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ep="installations",_T="installations-internal",gT=t=>{const e=t.getProvider("app").getImmediate(),n=pT(e),s=wr(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},mT=t=>{const e=t.getProvider("app").getImmediate(),n=wr(e,Ep).getImmediate();return{getId:()=>fT(n),getToken:i=>dT(n,i)}};function yT(){Yt(new Rt(Ep,gT,"PUBLIC")),Yt(new Rt(_T,mT,"PRIVATE"))}yT();_t(ip,Il);_t(ip,Il,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mo="fcm_token_details_db",IT=5,Ru="fcm_token_object_Store";async function AT(t){if("databases"in indexedDB&&!(await indexedDB.databases()).map(r=>r.name).includes(mo))return null;let e=null;return(await Er(mo,IT,{upgrade:async(s,i,r,o)=>{var a;if(i<2||!s.objectStoreNames.contains(Ru))return;const l=o.objectStore(Ru),c=await l.index("fcmSenderId").get(t);if(await l.clear(),!!c){if(i===2){const u=c;if(!u.auth||!u.p256dh||!u.endpoint)return;e={token:u.fcmToken,createTime:(a=u.createTime)!==null&&a!==void 0?a:Date.now(),subscriptionOptions:{auth:u.auth,p256dh:u.p256dh,endpoint:u.endpoint,swScope:u.swScope,vapidKey:typeof u.vapidKey=="string"?u.vapidKey:Ct(u.vapidKey)}}}else if(i===3){const u=c;e={token:u.fcmToken,createTime:u.createTime,subscriptionOptions:{auth:Ct(u.auth),p256dh:Ct(u.p256dh),endpoint:u.endpoint,swScope:u.swScope,vapidKey:Ct(u.vapidKey)}}}else if(i===4){const u=c;e={token:u.fcmToken,createTime:u.createTime,subscriptionOptions:{auth:Ct(u.auth),p256dh:Ct(u.p256dh),endpoint:u.endpoint,swScope:u.swScope,vapidKey:Ct(u.vapidKey)}}}}}})).close(),await so(mo),await so("fcm_vapid_details_db"),await so("undefined"),NT(e)?e:null}function NT(t){if(!t||!t.subscriptionOptions)return!1;const{subscriptionOptions:e}=t;return typeof t.createTime=="number"&&t.createTime>0&&typeof t.token=="string"&&t.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iI(t=Dd()){return nI().then(e=>{if(!e)throw Pe.create("unsupported-browser")},e=>{throw Pe.create("indexed-db-unsupported")}),wr(sn(t),"messaging").getImmediate()}async function rI(t,e){return t=sn(t),Np(t,e)}function oI(t,e){return t=sn(t),sI(t,e)}tI();const Rp=iI(Gh),aI=async()=>{try{const t=await rI(Rp,{vapidKey:"BJ-Cy91acaJ1K7efR3RltkE29snJH-ygssGHtqnyRPtnJNdMYUmkOw-uPu3mraS3Hw5MtqU4ajk4AmnktYnGyew"});t?console.log("FCM Token:",t):console.log("No registration token available.")}catch(t){console.error("An error occurred while retrieving token:",t)}};"serviceWorker"in navigator&&navigator.serviceWorker.register("/firebase-messaging-sw.js").then(t=>{console.log("Service Worker registered with scope:",t.scope)}).catch(t=>{console.log("Service Worker registration failed:",t)});aI();oI(Rp,t=>{var e,n,s;console.log(t),new Notification(String((e=t.notification)==null?void 0:e.title),{body:(n=t.notification)==null?void 0:n.body,icon:(s=t.notification)==null?void 0:s.icon})});const lI=$f(DS);lI.use(im()).mount("#app");
