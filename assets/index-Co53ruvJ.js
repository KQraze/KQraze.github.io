 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rv="FirebaseError";class ns extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=rv,Object.setPrototypeOf(this,ns.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,vr.prototype.create)}}class vr{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?ov(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new ns(i,a,s)}}function ov(t,e){return t.replace(av,(n,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const av=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rd=function(t){let e={},n={},s={},i="";try{const r=t.split(".");e=Fs(Uo(r[0])||""),n=Fs(Uo(r[1])||""),i=r[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:i}},lv=function(t){const e=Rd(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},cv=function(t){const e=Rd(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ae;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(ae||(ae={}));const mv={debug:ae.DEBUG,verbose:ae.VERBOSE,info:ae.INFO,warn:ae.WARN,error:ae.ERROR,silent:ae.SILENT},yv=ae.INFO,vv={[ae.DEBUG]:"log",[ae.VERBOSE]:"log",[ae.INFO]:"info",[ae.WARN]:"warn",[ae.ERROR]:"error"},bv=(t,e,...n)=>{if(e<t.logLevel)return;const s=new Date().toISOString(),i=vv[e];if(i)console[i](`[${s}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Nd{constructor(e){this.name=e,this._logLevel=yv,this._logHandler=bv,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in ae))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?mv[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,ae.DEBUG,...e),this._logHandler(this,ae.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,ae.VERBOSE,...e),this._logHandler(this,ae.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,ae.INFO,...e),this._logHandler(this,ae.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,ae.WARN,...e),this._logHandler(this,ae.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,ae.ERROR,...e),this._logHandler(this,ae.ERROR,...e)}}const Ev=(t,e)=>e.some(n=>t instanceof n);let Lc,Fc;function wv(){return Lc||(Lc=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Cv(){return Fc||(Fc=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Od=new WeakMap,Ho=new WeakMap,xd=new WeakMap,to=new WeakMap,Va=new WeakMap;function Sv(t){const e=new Promise((n,s)=>{const i=()=>{t.removeEventListener("success",r),t.removeEventListener("error",o)},r=()=>{n(At(t.result)),i()},o=()=>{s(t.error),i()};t.addEventListener("success",r),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&Od.set(n,t)}).catch(()=>{}),Va.set(e,t),e}function Tv(t){if(Ho.has(t))return;const e=new Promise((n,s)=>{const i=()=>{t.removeEventListener("complete",r),t.removeEventListener("error",o),t.removeEventListener("abort",o)},r=()=>{n(),i()},o=()=>{s(t.error||new DOMException("AbortError","AbortError")),i()};t.addEventListener("complete",r),t.addEventListener("error",o),t.addEventListener("abort",o)});Ho.set(t,e)}let jo={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return Ho.get(t);if(e==="objectStoreNames")return t.objectStoreNames||xd.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return At(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function Iv(t){jo=t(jo)}function Av(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const s=t.call(no(this),e,...n);return xd.set(s,e.sort?e.sort():[e]),At(s)}:Cv().includes(t)?function(...e){return t.apply(no(this),e),At(Od.get(this))}:function(...e){return At(t.apply(no(this),e))}}function Rv(t){return typeof t=="function"?Av(t):(t instanceof IDBTransaction&&Tv(t),Ev(t,wv())?new Proxy(t,jo):t)}function At(t){if(t instanceof IDBRequest)return Sv(t);if(to.has(t))return to.get(t);const e=Rv(t);return e!==t&&(to.set(t,e),Va.set(e,t)),e}const no=t=>Va.get(t);function Er(t,e,{blocked:n,upgrade:s,blocking:i,terminated:r}={}){const o=indexedDB.open(t,e),a=At(o);return s&&o.addEventListener("upgradeneeded",l=>{s(At(o.result),l.oldVersion,l.newVersion,At(o.transaction),l)}),n&&o.addEventListener("blocked",l=>n(l.oldVersion,l.newVersion,l)),a.then(l=>{r&&l.addEventListener("close",()=>r()),i&&l.addEventListener("versionchange",c=>i(c.oldVersion,c.newVersion,c))}).catch(()=>{}),a}function so(t,{blocked:e}={}){const n=indexedDB.deleteDatabase(t);return e&&n.addEventListener("blocked",s=>e(s.oldVersion,s)),At(n).then(()=>{})}const Nv=["get","getKey","getAll","getAllKeys","count"],Ov=["put","add","delete","clear"],io=new Map;function Bc(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(io.get(e))return io.get(e);const n=e.replace(/FromIndex$/,""),s=e!==n,i=Ov.includes(n);if(!(n in(s?IDBIndex:IDBObjectStore).prototype)||!(i||Nv.includes(n)))return;const r=async function(o,...a){const l=this.transaction(o,i?"readwrite":"readonly");let c=l.store;return s&&(c=c.index(a.shift())),(await Promise.all([c[n](...a),i&&l.done]))[0]};return io.set(e,r),r}Iv(t=>({...t,get:(e,n,s)=>Bc(e,n)||t.get(e,n,s),has:(e,n)=>!!Bc(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xv{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Pv(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Pv(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Wo="@firebase/app",Uc="0.10.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qo="[DEFAULT]",ob={[Wo]:"fire-core",[Dv]:"fire-core-compat",[Mv]:"fire-analytics",[kv]:"fire-analytics-compat",[Fv]:"fire-app-check",[Lv]:"fire-app-check-compat",[Bv]:"fire-auth",[Uv]:"fire-auth-compat",[$v]:"fire-rtdb",[Hv]:"fire-data-connect",[jv]:"fire-rtdb-compat",[Wv]:"fire-fn",[qv]:"fire-fn-compat",[Vv]:"fire-iid",[Kv]:"fire-iid-compat",[zv]:"fire-fcm",[Gv]:"fire-fcm-compat",[Yv]:"fire-perf",[Jv]:"fire-perf-compat",[Qv]:"fire-rc",[Xv]:"fire-rc-compat",[Zv]:"fire-gcs",[eb]:"fire-gcs-compat",[tb]:"fire-fst",[sb]:"fire-fst-compat",[nb]:"fire-vertex","fire-js":"fire-js",[ib]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ub=rb;function Pd(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:qo,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw qt.create("bad-app-name",{appName:String(i)});if(n||(n=Cd()),!n)throw qt.create("no-options");const r=Ui.get(i);if(r){if($o(n,r.options)&&$o(s,r.config))return r;throw qt.create("duplicate-app",{appName:i})}const o=new gv(i);for(const l of Vo.values())o.addComponent(l);const a=new cb(n,s,o);return Ui.set(i,a),a}function Dd(t=qo){const e=Ui.get(t);if(!e&&t===qo&&Cd())return Pd();if(!e)throw qt.create("no-app",{appName:t});return e}function _t(t,e,n){var s;let i=(s=ob[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ot.warn(a.join(" "));return}Yt(new Nt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vb(t){Yt(new Nt("platform-logger",e=>new xv(e),"PRIVATE")),Yt(new Nt("heartbeat",e=>new gb(e),"PRIVATE")),_t(Wo,Uc,t),_t(Wo,Uc,"esm2017"),_t("fire-js","")}vb("");var qc={};const Vc="@firebase/database",Kc="1.0.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ga="5",Hd="v",jd="s",Wd="r",qd="f",Vd=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Kd="ls",zd="p",zo="ac",Gd="websocket",Yd="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oo={},ao={};function Ya(t){const e=t.toString();return oo[e]||(oo[e]=new Ub),oo[e]}function $b(t,e){const n=t.toString();return ao[n]||(ao[n]=e()),ao[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const n of e.values())this.sendListen_(n);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let n="js";e["sdk."+n+"."+Ld.replace(/\./g,"-")]=1,Sd()?e["framework.cordova"]=1:sv()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=Hi.getInstance().currentlyOnline();return kc(this.interruptReasons_)&&e}}Rt.nextPersistentConnectionId_=0;Rt.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Go;function bE(t){Go=t}const lh=function(t){return typeof t=="number"?"number:"+$d(t):"string:"+t},ch=function(t){if(t.isLeafNode()){const e=t.val();T(typeof e=="string"||typeof e=="number"||typeof e=="object"&&bt(e,".sv"),"Priority must be a string or number.")}else T(t===Go||t.isEmpty(),"priority of unexpected type.");T(t===Go||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class NE extends Cr{compare(e,n){const s=e.node.compareTo(n.node);return s===0?xn(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return q.MIN}maxPost(){return q.MAX}makePost(e,n){const s=Se(e);return new q(n,s)}toString(){return".value"}}const OE=new NE;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qi(){return{value:null,children:new Map}}function hh(t,e,n){if(K(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=V(e);t.children.has(s)||t.children.set(s,qi());const i=t.children.get(s);e=ce(e),hh(i,e,n)}}function Yo(t,e,n){t.value!==null?n(e,t.value):ME(t,(s,i)=>{const r=new te(e.toString()+"/"+s);Yo(i,r,n)})}function ME(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LE{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n=Object.assign({},e);return this.last_&&Re(this.last_,(s,i)=>{n[s]=n[s]-i}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cu=10*1e3,FE=30*1e3,BE=5*60*1e3;class UE{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new LE(e);const s=cu+(FE-cu)*Math.random();Ts(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;Re(e,(i,r)=>{r>0&&bt(this.statsToReport_,i)&&(n[i]=r,s=!0)}),s&&this.server_.reportStats(n),Ts(this.reportStats_.bind(this),Math.floor(Math.random()*2*BE))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sr(t,e){return{eventCache:t,serverCache:e}}function Is(t,e,n,s){return Sr(new Qt(e,n,s),t.serverCache)}function ph(t,e,n,s){return Sr(t.eventCache,new Qt(e,n,s))}function Ki(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function An(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tr(t,e){return vh(e,t)}function VE(t,e,n,s,i){T(s>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:s,visible:i}),i&&(t.visibleWrites=As(t.visibleWrites,e,n)),t.lastWriteId=s}function KE(t,e,n,s){T(s>t.lastWriteId,"Stacking an older merge on top of newer ones"),t.allWrites.push({path:e,children:n,writeId:s,visible:!0}),t.visibleWrites=Jo(t.visibleWrites,e,n),t.lastWriteId=s}function zE(t,e){for(let n=0;n<t.allWrites.length;n++){const s=t.allWrites[n];if(s.writeId===e)return s}return null}function GE(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);T(n>=0,"removeWrite called with nonexistent writeId.");const s=t.allWrites[n];t.allWrites.splice(n,1);let i=s.visible,r=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&YE(a,s.path)?i=!1:Xe(s.path,a.path)&&(r=!0)),o--}if(i){if(r)return JE(t),!0;if(s.snap)t.visibleWrites=uu(t.visibleWrites,s.path);else{const a=s.children;Re(a,l=>{t.visibleWrites=uu(t.visibleWrites,pe(s.path,l))})}return!0}else return!1}function YE(t,e){if(t.snap)return Xe(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Xe(pe(t.path,n),e))return!0;return!1}function JE(t){t.visibleWrites=gh(t.allWrites,QE,Q()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function QE(t){return t.visible}function gh(t,e,n){let s=ot.empty();for(let i=0;i<t.length;++i){const r=t[i];if(e(r)){const o=r.path;let a;if(r.snap)Xe(n,o)?(a=Fe(n,o),s=As(s,a,r.snap)):Xe(o,n)&&(a=Fe(o,n),s=As(s,Q(),r.snap.getChild(a)));else if(r.children){if(Xe(n,o))a=Fe(n,o),s=Jo(s,a,r.children);else if(Xe(o,n))if(a=Fe(o,n),K(a))s=Jo(s,Q(),r.children);else{const l=Kn(r.children,V(a));if(l){const c=l.getChild(ce(a));s=As(s,Q(),c)}}}else throw ts("WriteRecord should have .snap or .children")}}return s}function mh(t,e,n,s,i){if(!s&&!i){const r=Pn(t.visibleWrites,e);if(r!=null)return r;{const o=Vt(t.visibleWrites,e);if(Xo(o))return n;if(n==null&&!Qo(o,Q()))return null;{const a=n||F.EMPTY_NODE;return Jn(o,a)}}}else{const r=Vt(t.visibleWrites,e);if(!i&&Xo(r))return n;if(!i&&n==null&&!Qo(r,Q()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(Xe(c.path,e)||Xe(e,c.path))},a=gh(t.allWrites,o,e),l=n||F.EMPTY_NODE;return Jn(a,l)}}}function XE(t,e,n){let s=F.EMPTY_NODE;const i=Pn(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(_e,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(n){const r=Vt(t.visibleWrites,e);return n.forEachChild(_e,(o,a)=>{const l=Jn(Vt(r,new te(o)),a);s=s.updateImmediateChild(o,l)}),fu(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=Vt(t.visibleWrites,e);return fu(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function ZE(t,e,n,s,i){T(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=pe(e,n);if(Qo(t.visibleWrites,r))return null;{const o=Vt(t.visibleWrites,r);return Xo(o)?i.getChild(n):Jn(o,i.getChild(n))}}function ew(t,e,n,s){const i=pe(e,n),r=Pn(t.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(n)){const o=Vt(t.visibleWrites,i);return Jn(o,s.getNode().getImmediateChild(n))}else return null}function tw(t,e){return Pn(t.visibleWrites,e)}function nw(t,e,n,s,i,r,o){let a;const l=Vt(t.visibleWrites,e),c=Pn(l,Q());if(c!=null)a=c;else if(n!=null)a=Jn(l,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],f=o.getCompare(),d=r?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let g=d.getNext();for(;g&&u.length<i;)f(g,s)!==0&&u.push(g),g=d.getNext();return u}else return[]}function sw(){return{visibleWrites:ot.empty(),allWrites:[],lastWriteId:-1}}function zi(t,e,n,s){return mh(t.writeTree,t.treePath,e,n,s)}function ol(t,e){return XE(t.writeTree,t.treePath,e)}function du(t,e,n,s){return ZE(t.writeTree,t.treePath,e,n,s)}function Gi(t,e){return tw(t.writeTree,pe(t.treePath,e))}function iw(t,e,n,s,i,r){return nw(t.writeTree,t.treePath,e,n,s,i,r)}function al(t,e,n){return ew(t.writeTree,t.treePath,e,n)}function yh(t,e){return vh(pe(t.treePath,e),t.writeTree)}function vh(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Qi;function Iw(t){T(!Qi,"__referenceConstructor has already been defined"),Qi=t}function Aw(){return T(Qi,"Reference.ts has not been loaded"),Qi}let Rw=1;class yu{constructor(e){this.listenProvider_=e,this.syncPointTree_=new oe(null),this.pendingWriteTree_=sw(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Nw(t,e,n,s,i){return VE(t.pendingWriteTree_,e,n,s,i),i?is(t,new In(sl(),e,n)):[]}function Ow(t,e,n,s){KE(t.pendingWriteTree_,e,n,s);const i=oe.fromObject(n);return is(t,new Yn(sl(),e,i))}function _n(t,e,n=!1){const s=zE(t.pendingWriteTree_,e);if(GE(t.pendingWriteTree_,e)){let r=new oe(null);return s.snap!=null?r=r.set(Q(),!0):Re(s.children,o=>{r=r.set(new te(o),!0)}),is(t,new Vi(s.path,r,n))}else return[]}function ri(t,e,n){return is(t,new In(il(),e,n))}function xw(t,e,n){const s=oe.fromObject(n);return is(t,new Yn(il(),e,s))}function Pw(t,e){return is(t,new qs(il(),e))}function Dw(t,e,n){const s=ul(t,n);if(s){const i=fl(s),r=i.path,o=i.queryId,a=Fe(r,e),l=new qs(rl(o),a);return dl(t,r,l)}else return[]}function Xi(t,e,n,s,i=!1){const r=e._path,o=t.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||Ah(o,e))){const l=Tw(o,e,n,s);Cw(o)&&(t.syncPointTree_=t.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!i){const u=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,f=t.syncPointTree_.findOnPath(r,(d,g)=>Xt(g));if(u&&!f){const d=t.syncPointTree_.subtree(r);if(!d.isEmpty()){const g=Lw(d);for(let _=0;_<g.length;++_){const v=g[_],E=v.query,x=Ph(t,v);t.listenProvider_.startListening(Rs(E),Vs(t,E),x.hashFn,x.onComplete)}}}!f&&c.length>0&&!s&&(u?t.listenProvider_.stopListening(Rs(e),null):c.forEach(d=>{const g=t.queryToTagMap.get(Ar(d));t.listenProvider_.stopListening(Rs(d),g)}))}Fw(t,c)}return a}function Rh(t,e,n,s){const i=ul(t,s);if(i!=null){const r=fl(i),o=r.path,a=r.queryId,l=Fe(o,e),c=new In(rl(a),l,n);return dl(t,o,c)}else return[]}function kw(t,e,n,s){const i=ul(t,s);if(i){const r=fl(i),o=r.path,a=r.queryId,l=Fe(o,e),c=oe.fromObject(n),u=new Yn(rl(a),l,c);return dl(t,o,u)}else return[]}function ta(t,e,n,s=!1){const i=e._path;let r=null,o=!1;t.syncPointTree_.foreachOnPath(i,(d,g)=>{const _=Fe(d,i);r=r||Kt(g,_),o=o||Xt(g)});let a=t.syncPointTree_.get(i);a?(o=o||Xt(a),r=r||Kt(a,Q())):(a=new Ch,t.syncPointTree_=t.syncPointTree_.set(i,a));let l;r!=null?l=!0:(l=!1,r=F.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((g,_)=>{const v=Kt(_,Q());v&&(r=r.updateImmediateChild(g,v))}));const c=Ah(a,e);if(!c&&!e._queryParams.loadsAllData()){const d=Ar(e);T(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const g=Bw();t.queryToTagMap.set(d,g),t.tagToQueryMap.set(g,d)}const u=Tr(t.pendingWriteTree_,i);let f=Sw(a,e,n,u,r,l);if(!c&&!o&&!s){const d=Ih(a,e);f=f.concat(Uw(t,e,d))}return f}function Nh(t,e,n){const i=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=Fe(o,e),c=Kt(a,l);if(c)return c});return mh(i,e,r,n,!0)}function Mw(t,e){const n=e._path;let s=null;t.syncPointTree_.foreachOnPath(n,(c,u)=>{const f=Fe(c,n);s=s||Kt(u,f)});let i=t.syncPointTree_.get(n);i?s=s||Kt(i,Q()):(i=new Ch,t.syncPointTree_=t.syncPointTree_.set(n,i));const r=s!=null,o=r?new Qt(s,!0,!1):null,a=Tr(t.pendingWriteTree_,e._path),l=Sh(i,e,a,r?o.getNode():F.EMPTY_NODE,r);return mw(l)}function is(t,e){return Oh(e,t.syncPointTree_,null,Tr(t.pendingWriteTree_,Q()))}function Oh(t,e,n,s){if(K(t.path))return xh(t,e,n,s);{const i=e.get(Q());n==null&&i!=null&&(n=Kt(i,Q()));let r=[];const o=V(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,u=yh(s,o);r=r.concat(Oh(a,l,c,u))}return i&&(r=r.concat(cl(i,t,s,n))),r}}function xh(t,e,n,s){const i=e.get(Q());n==null&&i!=null&&(n=Kt(i,Q()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=yh(s,o),u=t.operationForChild(o);u&&(r=r.concat(xh(u,a,l,c)))}),i&&(r=r.concat(cl(i,t,s,n))),r}function Ph(t,e){const n=e.query,s=Vs(t,n);return{hashFn:()=>(gw(e)||F.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?Dw(t,n._path,s):Pw(t,n._path);{const r=xb(i,n);return Xi(t,n,null,r)}}}}function Vs(t,e){const n=Ar(e);return t.queryToTagMap.get(n)}function Ar(t){return t._path.toString()+"$"+t._queryIdentifier}function ul(t,e){return t.tagToQueryMap.get(e)}function fl(t){const e=t.indexOf("$");return T(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new te(t.substr(0,e))}}function dl(t,e,n){const s=t.syncPointTree_.get(e);T(s,"Missing sync point for query tag that we're tracking");const i=Tr(t.pendingWriteTree_,e);return cl(s,n,i,null)}function Lw(t){return t.fold((e,n,s)=>{if(n&&Xt(n))return[Ir(n)];{let i=[];return n&&(i=Th(n)),Re(s,(r,o)=>{i=i.concat(o)}),i}})}function Rs(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(Aw())(t._repo,t._path):t}function Fw(t,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const i=Ar(s),r=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(r)}}}function Bw(){return Rw++}function Uw(t,e,n){const s=e._path,i=Vs(t,e),r=Ph(t,n),o=t.listenProvider_.startListening(Rs(e),i,r.hashFn,r.onComplete),a=t.syncPointTree_.subtree(s);if(i)T(!Xt(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,f)=>{if(!K(c)&&u&&Xt(u))return[Ir(u).query];{let d=[];return u&&(d=d.concat(Th(u).map(g=>g.query))),Re(f,(g,_)=>{d=d.concat(_)}),d}});for(let c=0;c<l.length;++c){const u=l[c];t.listenProvider_.stopListening(Rs(u),Vs(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sl{constructor(e,n,s,i){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=i}get key(){return K(this._path)?null:Qa(this._path)}get ref(){return new kt(this._repo,this._path)}get _queryIdentifier(){const e=lu(this._queryParams),n=za(e);return n==="{}"?"default":n}get _queryObject(){return lu(this._queryParams)}isEqual(e){if(e=sn(e),!(e instanceof Sl))return!1;const n=this._repo===e._repo,s=Xa(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+cE(this._path)}}class kt extends Sl{constructor(e,n){super(e,n,new nl,!1)}get parent(){const e=rh(this._path);return e===null?null:new kt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class zs{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new te(e),s=sa(this.ref,e);return new zs(this._node.getChild(n),s,_e)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new zs(i,sa(this.ref,s),_e)))}hasChild(e){const n=new te(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function wC(t,e){return t=sn(t),t._checkNotDeleted("ref"),sa(t._root,e)}function sa(t,e){return t=sn(t),V(t._path)===null?Zw("child","path",e):Bh("child","path",e),new kt(t._repo,pe(t._path,e))}function CC(t,e){Xw("update",e,t._path);const n=new yr;return uC(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function SC(t){t=sn(t);const e=new zh(()=>{}),n=new xr(e);return cC(t._repo,t,n).then(s=>new zs(s,new kt(t._repo,t._path),t._queryParams.getIndex()))}class xr{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const s=n._queryParams.getIndex();return new bC("value",this,new zs(e.snapshotNode,new kt(n._repo,n._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new EC(this,e,n):null}matches(e){return e instanceof xr?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function TC(t,e,n,s,i){const r=new zh(n,void 0),o=new xr(r);return dC(t._repo,t,o),()=>hC(t._repo,t,o)}function IC(t,e,n,s){return TC(t,"value",e)}Ew(kt);Iw(kt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function LC(t){bb(ub),Yt(new Nt("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return OC(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),_t(Vc,Kc,t),_t(Vc,Kc,"esm2017")}Rt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Rt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};LC();var FC="firebase",BC="10.14.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qS=/^[cdef][\w-]{21}$/,fa="";function VS(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const n=KS(t);return qS.test(n)?n:fa}catch{return fa}}function KS(t){return WS(t).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _p=new Map;function gp(t,e){const n=Mr(t);mp(n,e),zS(n,e)}function mp(t,e){const n=_p.get(t);if(n)for(const s of n)s(e)}function zS(t,e){const n=GS();n&&n.postMessage({key:t,fid:e}),YS()}let gn=null;function GS(){return!gn&&"BroadcastChannel"in self&&(gn=new BroadcastChannel("[Firebase] FID Change"),gn.onmessage=t=>{mp(t.data.key,t.data.fid)}),gn}function YS(){_p.size===0&&gn&&(gn.close(),gn=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JS="firebase-installations-database",QS=1,Nn="firebase-installations-store";let _o=null;function Al(){return _o||(_o=Er(JS,QS,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Nn)}}})),_o}async function er(t,e){const n=Mr(t),i=(await Al()).transaction(Nn,"readwrite"),r=i.objectStore(Nn),o=await r.get(n);return await r.put(e,n),await i.done,(!o||o.fid!==e.fid)&&gp(t,e.fid),e}async function yp(t){const e=Mr(t),s=(await Al()).transaction(Nn,"readwrite");await s.objectStore(Nn).delete(e),await s.done}async function Lr(t,e){const n=Mr(t),i=(await Al()).transaction(Nn,"readwrite"),r=i.objectStore(Nn),o=await r.get(n),a=e(o);return a===void 0?await r.delete(n):await r.put(a,n),await i.done,a&&(!o||o.fid!==a.fid)&&gp(t,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fT(t){const e=t,{installationEntry:n,registrationPromise:s}=await Rl(e);return s?s.catch(console.error):Nl(e).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dT(t,e=!1){const n=t;return await hT(n),(await Nl(n,e)).token}async function hT(t){const{registrationPromise:e}=await Rl(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pT(t){if(!t||!t.options)throw go("App Configuration");if(!t.name)throw go("App Name");const e=["projectId","apiKey","appId"];for(const n of e)if(!t.options[n])throw go(n);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}function go(t){return Rn.create("missing-app-config-values",{valueName:t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ep="installations",_T="installations-internal",gT=t=>{const e=t.getProvider("app").getImmediate(),n=pT(e),s=wr(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},mT=t=>{const e=t.getProvider("app").getImmediate(),n=wr(e,Ep).getImmediate();return{getId:()=>fT(n),getToken:i=>dT(n,i)}};function yT(){Yt(new Nt(Ep,gT,"PUBLIC")),Yt(new Nt(_T,mT,"PRIVATE"))}yT();_t(ip,Il);_t(ip,Il,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mo="fcm_token_details_db",IT=5,Nu="fcm_token_object_Store";async function AT(t){if("databases"in indexedDB&&!(await indexedDB.databases()).map(r=>r.name).includes(mo))return null;let e=null;return(await Er(mo,IT,{upgrade:async(s,i,r,o)=>{var a;if(i<2||!s.objectStoreNames.contains(Nu))return;const l=o.objectStore(Nu),c=await l.index("fcmSenderId").get(t);if(await l.clear(),!!c){if(i===2){const u=c;if(!u.auth||!u.p256dh||!u.endpoint)return;e={token:u.fcmToken,createTime:(a=u.createTime)!==null&&a!==void 0?a:Date.now(),subscriptionOptions:{auth:u.auth,p256dh:u.p256dh,endpoint:u.endpoint,swScope:u.swScope,vapidKey:typeof u.vapidKey=="string"?u.vapidKey:Ct(u.vapidKey)}}}else if(i===3){const u=c;e={token:u.fcmToken,createTime:u.createTime,subscriptionOptions:{auth:Ct(u.auth),p256dh:Ct(u.p256dh),endpoint:u.endpoint,swScope:u.swScope,vapidKey:Ct(u.vapidKey)}}}else if(i===4){const u=c;e={token:u.fcmToken,createTime:u.createTime,subscriptionOptions:{auth:Ct(u.auth),p256dh:Ct(u.p256dh),endpoint:u.endpoint,swScope:u.swScope,vapidKey:Ct(u.vapidKey)}}}}}})).close(),await so(mo),await so("fcm_vapid_details_db"),await so("undefined"),RT(e)?e:null}function RT(t){if(!t||!t.subscriptionOptions)return!1;const{subscriptionOptions:e}=t;return typeof t.createTime=="number"&&t.createTime>0&&typeof t.token=="string"&&t.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rp(t,e){if(!navigator)throw Pe.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw Pe.create("permission-blocked");return await YT(t,e==null?void 0:e.vapidKey),await GT(t,e==null?void 0:e.serviceWorkerRegistration),FT(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ZT=t=>{const e=new KT(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>XT(e,n)),e},eI=t=>{const e=t.getProvider("messaging").getImmediate();return{getToken:s=>Rp(e,s)}};function tI(){Yt(new Nt("messaging",ZT,"PUBLIC")),Yt(new Nt("messaging-internal",eI,"PRIVATE")),_t(Pu,Du),_t(Pu,Du,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iI(t=Dd()){return nI().then(e=>{if(!e)throw Pe.create("unsupported-browser")},e=>{throw Pe.create("indexed-db-unsupported")}),wr(sn(t),"messaging").getImmediate()}async function rI(t,e){return t=sn(t),Rp(t,e)}function oI(t,e){return t=sn(t),sI(t,e)}tI();const Np=iI(Gh),aI=async()=>{try{const t=await rI(Np,{vapidKey:"BJ-Cy91acaJ1K7efR3RltkE29snJH-ygssGHtqnyRPtnJNdMYUmkOw-uPu3mraS3Hw5MtqU4ajk4AmnktYnGyew"});t?console.log("FCM Token:",t):console.log("No registration token available.")}catch(t){console.error("An error occurred while retrieving token:",t)}};"serviceWorker"in navigator&&navigator.serviceWorker.register("/firebase-messaging-sw.js").then(t=>{console.log("Service Worker registered with scope:",t.scope)}).catch(t=>{console.log("Service Worker registration failed:",t)});aI();oI(Np,t=>{console.log(t)});const lI=$f(DS);lI.use(im()).mount("#app");
