 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rd=function(t){let e={},n={},s={},i="";try{const r=t.split(".");e=Fs($o(r[0])||""),n=Fs($o(r[1])||""),i=r[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:i}},lv=function(t){const e=Rd(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},cv=function(t){const e=Rd(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vb(t){Yt(new Nt("platform-logger",e=>new xv(e),"PRIVATE")),Yt(new Nt("heartbeat",e=>new gb(e),"PRIVATE")),_t(qo,Uc,t),_t(qo,Uc,"esm2017"),_t("fire-js","")}vb("");var qc={};const Vc="@firebase/database",Kc="1.0.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class NE extends Sr{compare(e,n){const s=e.node.compareTo(n.node);return s===0?xn(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return q.MIN}maxPost(){return q.MAX}makePost(e,n){const s=Se(e);return new q(n,s)}toString(){return".value"}}const OE=new NE;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JS="firebase-installations-database",QS=1,Nn="firebase-installations-store";let go=null;function Al(){return go||(go=wr(JS,QS,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Nn)}}})),go}async function er(t,e){const n=Lr(t),i=(await Al()).transaction(Nn,"readwrite"),r=i.objectStore(Nn),o=await r.get(n);return await r.put(e,n),await i.done,(!o||o.fid!==e.fid)&&gp(t,e.fid),e}async function yp(t){const e=Lr(t),s=(await Al()).transaction(Nn,"readwrite");await s.objectStore(Nn).delete(e),await s.done}async function Fr(t,e){const n=Lr(t),i=(await Al()).transaction(Nn,"readwrite"),r=i.objectStore(Nn),o=await r.get(n),a=e(o);return a===void 0?await r.delete(n):await r.put(a,n),await i.done,a&&(!o||o.fid!==a.fid)&&gp(t,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ep="installations",_T="installations-internal",gT=t=>{const e=t.getProvider("app").getImmediate(),n=pT(e),s=Cr(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},mT=t=>{const e=t.getProvider("app").getImmediate(),n=Cr(e,Ep).getImmediate();return{getId:()=>fT(n),getToken:i=>dT(n,i)}};function yT(){Yt(new Nt(Ep,gT,"PUBLIC")),Yt(new Nt(_T,mT,"PRIVATE"))}yT();_t(ip,Il);_t(ip,Il,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yo="fcm_token_details_db",IT=5,Nu="fcm_token_object_Store";async function AT(t){if("databases"in indexedDB&&!(await indexedDB.databases()).map(r=>r.name).includes(yo))return null;let e=null;return(await wr(yo,IT,{upgrade:async(s,i,r,o)=>{var a;if(i<2||!s.objectStoreNames.contains(Nu))return;const l=o.objectStore(Nu),c=await l.index("fcmSenderId").get(t);if(await l.clear(),!!c){if(i===2){const u=c;if(!u.auth||!u.p256dh||!u.endpoint)return;e={token:u.fcmToken,createTime:(a=u.createTime)!==null&&a!==void 0?a:Date.now(),subscriptionOptions:{auth:u.auth,p256dh:u.p256dh,endpoint:u.endpoint,swScope:u.swScope,vapidKey:typeof u.vapidKey=="string"?u.vapidKey:Ct(u.vapidKey)}}}else if(i===3){const u=c;e={token:u.fcmToken,createTime:u.createTime,subscriptionOptions:{auth:Ct(u.auth),p256dh:Ct(u.p256dh),endpoint:u.endpoint,swScope:u.swScope,vapidKey:Ct(u.vapidKey)}}}else if(i===4){const u=c;e={token:u.fcmToken,createTime:u.createTime,subscriptionOptions:{auth:Ct(u.auth),p256dh:Ct(u.p256dh),endpoint:u.endpoint,swScope:u.swScope,vapidKey:Ct(u.vapidKey)}}}}}})).close(),await io(yo),await io("fcm_vapid_details_db"),await io("undefined"),RT(e)?e:null}function RT(t){if(!t||!t.subscriptionOptions)return!1;const{subscriptionOptions:e}=t;return typeof t.createTime=="number"&&t.createTime>0&&typeof t.token=="string"&&t.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iI(t=Dd()){return nI().then(e=>{if(!e)throw Pe.create("unsupported-browser")},e=>{throw Pe.create("indexed-db-unsupported")}),Cr(sn(t),"messaging").getImmediate()}async function rI(t,e){return t=sn(t),Rp(t,e)}function oI(t,e){return t=sn(t),sI(t,e)}tI();const Np=iI(Gh);"serviceWorker"in navigator&&navigator.serviceWorker.register("/pwa/firebase-messaging-sw.js").then(t=>{console.log("Service Worker registered with scope:",t.scope)}).catch(t=>{console.log("Service Worker registration failed:",t)});rI(Np,{vapidKey:"BJ-Cy91acaJ1K7efR3RltkE29snJH-ygssGHtqnyRPtnJNdMYUmkOw-uPu3mraS3Hw5MtqU4ajk4AmnktYnGyew"}).then(t=>{t?console.log("FCM Token:",t):console.log("No registration token available.")}).catch(t=>{console.log("An error occurred while retrieving token.",t)});oI(Np,t=>{console.log(t)});const aI=$f(DS);aI.use(im()).mount("#app");
